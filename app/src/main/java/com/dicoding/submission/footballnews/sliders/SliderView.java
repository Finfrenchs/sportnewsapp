...
public class SliderView extends ViewPager {
    ...
    public static final int DEFAULT_SCROLL_DURATION = 220;
    ...
    public SliderView(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    private void init() {
        setDurationSroll(DEFAULT_SCROLL_DURATION);
    ...
    public void setDurationSroll(int millis) {
        try {
